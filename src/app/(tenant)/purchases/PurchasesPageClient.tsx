    ...
    <div className="max-w-5xl mx-auto py-8 px-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Record bills received from vendors for goods and services</p>
        </div>
        <button
      ...
      {saved && (
        <div className="mb-4 bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3 rounded-lg">
          Purchase entry saved successfully. Accounting entries created automatically.
        </div>
      )}
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {entries.length === 0 ? (
          <div className="px-6 py-12 text-center text-slate-400">
            <p className="font-medium">No purchase entries yet</p>
